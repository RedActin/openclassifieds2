        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>
                    ...
                    <br>upload_max_filesize: <?=ini_get('upload_max_filesize')?> ,<br>max_execution_time: <?=ini_get('max_execution_time')?> <?=__('seconds')?> <br><?=__('limited to 10.000 at a time')?>, <?=__('1 MB file')?>.
                </p>
